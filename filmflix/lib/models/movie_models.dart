class MovieSearchItem {
  ...
  MovieSearchItem({
    //dit zorgt voor een constructor voor de MovieSearchItem class, waarbij deid, title en raw data verplicht zijn, en de year, poster en tmdbId optioneel zijn.
    required this.id,
    required this.title,
    this.year,
    this.poster,
  ...
  factory MovieSearchItem.fromJson(Map<String, dynamic> json) {
    //dit zorgt voor een factory constructor die een MovieSearchItem maakt van een JSON object. Hierbij wordt gekeken naar de id, title, year, poster en tmdbId in het JSON object, en worden deze gebruikt om een MovieSearchItem te maken.
    return MovieSearchItem(
      //dit maakt een MovieSearchItem aan met de id, title, year, poster, raw data en tmdbId uit het JSON object. Hierbij wordt gekeken naar de id, title, year, poster en tmdbId in het JSON object, en worden deze gebruikt om een MovieSearchItem te maken.
      ...
      year:
          ...
          (json['release_date'] != null
              ...
              : null),
      poster:
          json['imageSet']?['verticalPoster']?['w240'] ??
...
class ImageSet {
  ...
  Map<String, dynamic> toJson() {
    return {'verticalPoster': verticalPoster?.toJson()};
  }
}
...
class VerticalPoster {
  ...
  factory VerticalPoster.fromJson(Map<String, dynamic> json) {
    return VerticalPoster(w160: json['w160'] as String?);
  }
